...
router
  ...
  .post(upload.array("image", 5), catchAsync(buildingControllers.create));
...
router
  .route("/:id/edit")
  .get(catchAsync(buildingControllers.editForm))
  .put(
...
//sensitivity
router.get("/:id/sensitivity/new", catchAsync(sensitivityControllers.new));
router.post("/:id/sensitivity", catchAsync(sensitivityControllers.create));
